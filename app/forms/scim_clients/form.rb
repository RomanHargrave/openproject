  ...
  class Form < ApplicationForm
    form do |client_form|
      ...
      client_form.select_list(
        ...
        AuthProvider.all.each do |provider|
          select.option(
            value: provider.id,
      ...
      client_form.select_list(
        ...
        data: { action: "scim-clients--form-inputs#updateFormInputs", "scim-clients--form-inputs-target": "authenticationMethodInput" }
      ) do |select|
        ScimClient.authentication_methods.keys.each do |method|
          select.option(
            value: method,
